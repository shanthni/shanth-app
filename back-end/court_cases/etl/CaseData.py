...
from court_cases.database_layer.CaseDataHandler import CaseDBHandler
...
class CDLoader:
    ...
    def map_data(self):
        ...
        for i in ['termination_data', 'filing_data', 'case_data']:
            self.DBHandler.add_ids(i)
        print("Updated ids and added indexes\n")
